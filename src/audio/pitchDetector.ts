...
export function detectPitchYin(buffer: Float32Array, sampleRate: number, minVolume = 0.006): PitchReading {
  let sumSquares = 0;
  ...
  return frequency >= 130 && frequency <= 1000 && clarity >= 0.6 ? { frequency, clarity, rms } : null;
}
